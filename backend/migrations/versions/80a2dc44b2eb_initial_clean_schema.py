...
Revision ID: 80a2dc44b2eb
Revises: 
Create Date: 2026-01-17 13:34:59.400609
...
def upgrade():
    ...
    sa.Column('coverage_areas', postgresql.JSON(astext_type=Text()), nullable=False),
