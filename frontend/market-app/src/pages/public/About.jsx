              ...
              <div className="bg-green-100 rounded-lg p-8">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg p-6 shadow-md">
                    <BuildingStorefrontIcon className="h-10 w-10 text-green-600 mb-3" />
                  ...
                  <div className="bg-white rounded-lg p-6 shadow-md">
                    <GlobeAltIcon className="h-10 w-10 text-green-600 mb-3" />
                  ...
                  <div className="bg-white rounded-lg p-6 shadow-md col-span-2">
                    <div className="text-center">
                      <span className="text-4xl font-bold text-green-600">2023</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-block bg-green-700 text-white px-8 py-3 rounded-md font-semibold hover:bg-green-800 transition-colors border border-green-500"
            >
              Become a Merchant
            </a>
          </div>
